...
<body>
	...
	<div class="content">
		...
		<p align="center">Please fill out all the information to create an
			auction. If information is not filled out, the post will not be
			successful.</p>
			...
			<div class="grid pg_login">
				...
				<div class="grid_item one-half create_acc">
					...
					<div style="Display:" class="tessss">
						<p>
							<b>Item Name</b>: <input class="borderless" type="text"
						...
						<p>
							<b>Condition</b>: <select name="conditionType" required>
								<option>New</option>
						...
						<p>
							<b>Manufacturer</b>: <input class="borderless" type="text"
								name="manufacturer" required>
						</p>

						<p>
							<b>Size</b> (US Men's): <select name="size" required>
								<option>4</option>
								<option>4.5</option>
								<option>5</option>
								<option>5.5</option>
						...
						<p>
							<b>Color</b>: <select name="color" required>
								<option>Black</option>
								<option>Grey</option>
								<option>Brown</option>
								<option>Tan</option>
						...
						<label for="uploadfile"><b>File name</b>: <input
							type="file" name="photo" accept="image/*" size="50" required /></label><br><Br><br><br><Br><br>
					</div>
				</div>
				...
				<div class="grid_item one-half sign_in">
					...
					<div style="Display:">
						...
						<p>
							<b>Start Date</b>: <input class="borderless"
								type="datetime-local" name="startDate" required>
						</p>

						<p>
							<b>End Date</b>: <input class="borderless" type="datetime-local"
								name="endDate" required>
						</p>

						<p>
							<b>Bid Increment</b>: <input class="borderless" type="text"
								name="bidIncrement" required>
						</p>

						<p>
							<b>Minimum Bid Permitted</b>: <input class="borderless"
								type="text" name="minBid" required>
						</p>

						<p>
							<b>Starting Price</b>: <input class="borderless" type="text"
								name="startingPrice" required>
						</p>

						<p class="h3move">
							<button class="btn alt" value="Save">Create Auction</button>
						</p>
					</div>
				</div>
			</div>
